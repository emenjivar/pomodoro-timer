...
class SetSoundsEnableUseCaseTest {
    ...
    private lateinit var useCase: com.emenjivar.pomodoro.usecases.SetSoundsEnableUseCase

    @Before
    fun setup() {
        repository = Mockito.mock(com.emenjivar.pomodoro.data.SettingsRepository::class.java)
        useCase = com.emenjivar.pomodoro.usecases.SetSoundsEnableUseCase(repository)
    }
